    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_photo', models.ImageField(blank=True, null=True, upload_to='auto_photos/')),
        ...
        migrations.AddField(
            model_name='auto',
            name='sell_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cars.sellstatus'),
        ),
    ]
